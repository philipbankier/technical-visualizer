...
- Treat this directory as the standalone repository root for `technical-visualizer`.
- Do not publish the parent workspace as this tool's repo.
- Use `script/lint`, `script/test`, `script/smoke`, and `script/security` for release checks.
